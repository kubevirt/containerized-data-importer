...
var _ = Describe("[rfe_id:1130][crit:medium][posneg:negative][vendor:cnv-qe@redhat.com][level:component]Validation tests", func() {
	...
	Context("when creating data volumes from manual manifests", func() {
		table.DescribeTable("with manifests Datavolume should", func(destinationFile string, expectError bool, errorContains ...string) {
			...
			table.Entry("[test_id:1767][posneg:positive]succeed with missing PVC spec", "manifests/dvMissingPVCSpec.yaml", false),
			...
			table.Entry("[test_id:1768][posneg:positive]succeed with missing resources spec", "manifests/dvMissingResourceSpec.yaml", false),
			table.Entry("[test_id:3921][posneg:positive]succeed with missing PVC size", "manifests/dvMissingPVCSize.yaml", false),
			...
			table.Entry("[test_id:1923][posneg:positive]succeed with missing storage size", "manifests/dvMissingRequestSpec.yaml", false),
