...
var _ = Describe("[vendor:cnv-qe@redhat.com][level:component]DataVolume tests", func() {
	...
	Describe("Priority class on datavolume should transfer to  pods", func() {
		...
		Describe("Host-assisted clone", Serial, func() {
	...
	DescribeTable("Events and Conditions from Prime PVC", decorators.RequiresCsiDriver, func(url func() string, containsPrimeEvent bool) {
