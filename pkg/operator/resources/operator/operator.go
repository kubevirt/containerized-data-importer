				...
				"spec": {
					Properties: map[string]extv1.JSONSchemaProps{
						...
						"infra": {
							...
							Type:        "object",
							Properties:  createAffinitySchema(),
						},
						"workload": {
						...
						"config": {
							...
							Type:        "object",
							Properties:  cluster.CreateConfigPropertiesSchema(),
						},
						"certConfig": {
							Type:        "object",
...
func createAffinitySchema() map[string]extv1.JSONSchemaProps {
										...
										"preference": {
											...
											Properties: map[string]extv1.JSONSchemaProps{
												"matchExpressions": {
													...
													Type:        "array",
													Items:       createNodeSelectorSchema(),
												},
												"matchFields": {
								...
								Schema: &extv1.JSONSchemaProps{
									...
									Properties: map[string]extv1.JSONSchemaProps{
										"podAffinityTerm": {
											...
											Type:        "object",
											Properties:  createPodSelectorSchema(),
											Required: []string{
												"topologyKey",
											},
										},
...
func createPodSelectorSchema() map[string]extv1.JSONSchemaProps {
	return map[string]extv1.JSONSchemaProps{
		"labelSelector": {
...
func createNodeSelectorSchema() *extv1.JSONSchemaPropsOrArray {
	return &extv1.JSONSchemaPropsOrArray{
		Schema: &extv1.JSONSchemaProps{
