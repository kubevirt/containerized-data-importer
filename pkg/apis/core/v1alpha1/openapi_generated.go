...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubevirt.io/containerized-data-importer/pkg/apis/core/v1alpha1.DataVolumeTransferMetrics": schema_pkg_apis_core_v1alpha1_DataVolumeTransferMetrics(ref),
...
func schema_pkg_apis_core_v1alpha1_DataVolumeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"transferMetrics": {
						SchemaProps: spec.SchemaProps{
							Description: "TransferMetrics provides fine-grained performance and progress counters for data sources that support it",
							Ref:         ref("kubevirt.io/containerized-data-importer/pkg/apis/core/v1alpha1.DataVolumeTransferMetrics"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"kubevirt.io/containerized-data-importer/pkg/apis/core/v1alpha1.DataVolumeCondition", "kubevirt.io/containerized-data-importer/pkg/apis/core/v1alpha1.DataVolumeTransferMetrics"},
	}
}

func schema_pkg_apis_core_v1alpha1_DataVolumeTransferMetrics(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "DataVolumeTransferMetrics",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"totalBytesSaved": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"totalBytesSaved"},
			},
		},
	}
}
