...
func (in *DataVolumeStatus) DeepCopyInto(out *DataVolumeStatus) {
	*out = *in
	...
	out.TransferMetrics = in.TransferMetrics
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataVolumeTransferMetrics) DeepCopyInto(out *DataVolumeTransferMetrics) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataVolumeTransferMetrics.
func (in *DataVolumeTransferMetrics) DeepCopy() *DataVolumeTransferMetrics {
	if in == nil {
		return nil
	}
	out := new(DataVolumeTransferMetrics)
	in.DeepCopyInto(out)
	return out
}
