...
type DataVolumeTransferMetrics struct {
	TotalBytesSaved int64 `json:"totalBytesSaved" description:"shows the number of bytes that have been copied from the source and successfully saved to the destination storage"`
}
