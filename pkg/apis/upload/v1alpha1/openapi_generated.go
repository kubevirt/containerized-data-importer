...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequest":       schema_pkg_apis_upload_v1alpha1_UploadTokenRequest(ref),
		"kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestList":   schema_pkg_apis_upload_v1alpha1_UploadTokenRequestList(ref),
		"kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestSpec":   schema_pkg_apis_upload_v1alpha1_UploadTokenRequestSpec(ref),
		"kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestStatus": schema_pkg_apis_upload_v1alpha1_UploadTokenRequestStatus(ref),
	}
}
...
func schema_pkg_apis_upload_v1alpha1_UploadTokenRequest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestSpec", "kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequestStatus"},
	}
}
...
func schema_pkg_apis_upload_v1alpha1_UploadTokenRequestList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequest"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubevirt.io/containerized-data-importer-api/pkg/apis/upload/v1alpha1.UploadTokenRequest"},
	}
}
