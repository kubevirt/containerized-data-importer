...
http_file(
    ...
    sha256 = "18e0d2f2730b67651303fb406437ec52b8570a5cb4d09149ab57514cfdade468",
    urls = ["https://github.com/oVirt/python-ovirt-engine-sdk4/releases/download/4.6.2/python3-ovirt-engine-sdk4-4.6.2-1.el9.x86_64.rpm"],
)

http_file(
    name = "ovirt-imageio-client",
    sha256 = "1b382eb8b39e03412d0a7c238505f559c5c16f28e9aa0aa025ab9f0695522434",
    urls = ["https://download.copr.fedorainfracloud.org/results/nsoffer/ovirt-imageio-preview/centos-stream-9-x86_64/05749705-ovirt-imageio/ovirt-imageio-client-2.5.1-0.202304060651.git4e5f7e0.el9.x86_64.rpm"],
)

http_file(
    name = "ovirt-imageio-client-aarch64",
    sha256 = "f59d2ea74f9f8f53e7de1e0cc6a9724982e8fb22394f7a52840e31277370e5ff",
    urls = ["https://download.copr.fedorainfracloud.org/results/nsoffer/ovirt-imageio-preview/centos-stream-9-aarch64/05749705-ovirt-imageio/ovirt-imageio-client-2.5.1-0.202304060651.git4e5f7e0.el9.aarch64.rpm"],
)

http_file(
    name = "ovirt-imageio-common",
    sha256 = "7f826ec3e6d61ba6833ea28d755d1ad5a14c89110008f0666cca5ecb3a1a9498",
    urls = ["https://download.copr.fedorainfracloud.org/results/nsoffer/ovirt-imageio-preview/centos-stream-9-x86_64/05749705-ovirt-imageio/ovirt-imageio-common-2.5.1-0.202304060651.git4e5f7e0.el9.x86_64.rpm"],
)

http_file(
    name = "ovirt-imageio-common-aarch64",
    sha256 = "a4942c9201614a6d5fb7f7a4e386e72a4d6c5dfd38d7b5adc63dc5929bb137ad",
    urls = ["https://download.copr.fedorainfracloud.org/results/nsoffer/ovirt-imageio-preview/centos-stream-9-aarch64/05749705-ovirt-imageio/ovirt-imageio-common-2.5.1-0.202304060651.git4e5f7e0.el9.aarch64.rpm"],
)
...
rpm(
    ...
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-2.34-82.el9.aarch64.rpm"],
)

rpm(
    name = "glibc-0__2.34-82.el9.x86_64",
    sha256 = "fbc1d1f04ac348d5226d3ed4035fdb6e9f202a1412510d4b495de3f7f1b1a4d0",
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-2.34-82.el9.x86_64.rpm"],
)
...
rpm(
    ...
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-common-2.34-82.el9.aarch64.rpm"],
)

rpm(
    name = "glibc-common-0__2.34-82.el9.x86_64",
    sha256 = "63797813fb79c4b445bf6f9fe73368362fa1d859a9332d214d4504f14ba74b6d",
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-common-2.34-82.el9.x86_64.rpm"],
)
...
rpm(
    ...
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/glibc-minimal-langpack-2.34-82.el9.aarch64.rpm"],
)

rpm(
    name = "glibc-minimal-langpack-0__2.34-82.el9.x86_64",
    sha256 = "7a95d438bb5ed9fc4aa9a1a6772394a874bb94a599949ec8afea1261b09fc518",
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/glibc-minimal-langpack-2.34-82.el9.x86_64.rpm"],
)
...
rpm(
    ...
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/aarch64/os/Packages/libcurl-minimal-7.76.1-26.el9.aarch64.rpm"],
)

rpm(
    name = "libcurl-minimal-0__7.76.1-26.el9.x86_64",
    sha256 = "b9c24d7a8e0c9e840b7d799e478870c75cb0101f8e3aaaca163d25d3f661b652",
    urls = ["http://mirror.stream.centos.org/9-stream/BaseOS/x86_64/os/Packages/libcurl-minimal-7.76.1-26.el9.x86_64.rpm"],
)
