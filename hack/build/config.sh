...
OVIRT_POPULATOR="ovirt-populator"
OPENSTACK_POPULATOR="openstack-populator"
...
BUILDER_IMAGE=${BUILDER_IMAGE:-quay.io/kubevirt/kubevirt-cdi-bazel-builder:2308300918-2e1e5eb67}

BINARIES="cmd/${OPERATOR} cmd/${CONTROLLER} cmd/${IMPORTER} cmd/${CLONER} cmd/${APISERVER} cmd/${UPLOADPROXY} cmd/${UPLOADSERVER} cmd/${OPERATOR} cmd/${OVIRT_POPULATOR} cmd/${OPENSTACK_POPULATOR} tools/${FUNC_TEST_INIT} tools/${FUNC_TEST_REGISTRY_INIT} tools/${FUNC_TEST_BAD_WEBSERVER} tools/${FUNC_TEST_PROXY} tools/${FUNC_TEST_POPULATOR}"
...
OVIRT_POPULATOR_IMAGE_NAME=${OVIRT_POPULATOR_IMAGE_NAME:-ovirt-populator}
OPENSTACK_POPULATOR_IMAGE_NAME=${OPENSTACK_POPULATOR_IMAGE_NAME:-openstack-populator}
