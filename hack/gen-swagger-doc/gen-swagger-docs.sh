...
top_level_models=$(grep '&[A-Za-z]*{},' staging/src/kubevirt.io/containerized-data-importer-api/pkg/apis/core/${VERSION}/register.go staging/src/kubevirt.io/containerized-data-importer-api/pkg/apis/upload/${VERSION}/register.go | sed 's/.*&//;s/{},//')
