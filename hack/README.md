...
- `cluster-up`: start a default Kubernetes or Open Shift cluster. set KUBEVIRT_PROVIDER environment variable to either 'k8s-1.15.1' or 'os-3.11.0' to select the type of cluster. set KUBEVIRT_NUM_NODES to something higher than 1 to have more than one node.
...
|--------------------|---------------|-----------------------------|
|KUBEVIRT_PROVIDER   | k8s-1.15.1    | os-3.11.0-crio or okd-4.1.2 |
